...
const ProfileView = () => {
  ...
  const updateBalance = () => {
    api
        ...
        .then(apiResponse => {
          ...
          setBalance(apiResponse.data.user_balance);
        })
        .catch(error => {
  ...
  function poll_for_notifications() {
    ...
    .then(apiResponse => {
      ...
      showSuccessMessage("New transaction was successfully processed!");
      updateBalance();
    })
    .catch(error => {
      console.log('error', error);
    ...
    api
        ...
        .then(apiResponse => {
          ...
          if (apiResponse.data.transactions.length !== 0) {
            ...
            var new_transactions_dedup = dedup(new_transactions, 'transactionId');
  ...
  <div>
    ...
    <section id="sidebar">
      <div className="item-wrapper pb-16">
        ...
        <p className="mini-title">Card Number {localStorage.getItem('card_id')}</p>
        ...
        <div className="balance-header">
          ...
          <div className="buttons">
            <button className="bank-btn black" data-toggle="modal" data-target="#paymentModal">
              ...
              <span>Make a money transfer</span>
            </button>
                ...
                <table className="table custom-table">
                  <thead>
                      <tr>
                          ...
                          <th scope="col">Counterparty and destination</th>
