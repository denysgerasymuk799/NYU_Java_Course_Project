...
import DailyStatModal from '../../modules/DailyStatModal'
import MonthlyStatModal from '../../modules/MonthlyStatModal'
  ...
  <div>
    ...
    <section id="sidebar">
      <div className="item-wrapper pb-16">
        ...
        <div className="mt-20">
          <button className="bank-btn black" data-toggle="modal" data-target="#dailyStatModal">
            <i className="fa fa-line-chart" aria-hidden="true"></i>
            <span>Денна статистика</span>
          </button>
          <button className="bank-btn mt-10" data-toggle="modal" data-target="#monthlyStatModal">
            <i className="fa fa-pie-chart" aria-hidden="true"></i>
            <span>Місячна статистика</span>
          </button>
        </div>
      </div>
    </section>
